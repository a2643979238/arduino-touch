...
public:
  ...
  // 检查是否已连接设备
  bool isConnected() { return HIDUniversal::isReady(); }
  ...
  // 检查是否有设备连接
  inline bool hasDevices() { return totalDevices > 0; }
...
private:
  ...
  inline uint16_t getRelativeTime() { return (uint16_t)(millis() & 0xFFFF); }
  ...
  inline void debugPrintHex(uint8_t value) {}
#endif
